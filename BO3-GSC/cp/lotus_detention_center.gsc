...
function function_3604a049() {
  ...
  [
    [var_de3c864]
  ] - > initialize("phalanx_reverse_wedge", v_start, v_end, 2, 5, var_f835ddae, var_f835ddae);
...
function detention_center_phalanx() {
  ...
  [
    [phalanx_left]
  ] - > initialize("phanalx_wedge", v_start, v_end, 1, n_phalanx, var_7947347f, var_73fc544);
}
